 ...
 */
final class Version20200926193343 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reminders DROP repeatable, CHANGE payment_id payments_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reminders ADD repeatable TINYINT(1) NOT NULL, CHANGE payments_id payment_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE reminders ADD CONSTRAINT FK_6D92B9D44C3A3BB FOREIGN KEY (payment_id) REFERENCES payment (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
